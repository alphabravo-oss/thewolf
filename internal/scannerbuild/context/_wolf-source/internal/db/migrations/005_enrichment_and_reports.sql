...
CREATE INDEX IF NOT EXISTS idx_tool_summaries_scan_id ON tool_summaries (
    scan_id
);
...
CREATE INDEX IF NOT EXISTS idx_scan_recommendations_scan_id ON scan_recommendations (
    scan_id
);
